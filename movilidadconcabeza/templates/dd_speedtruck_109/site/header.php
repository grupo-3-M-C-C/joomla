...
?>
<a class=" bd-logo-2 animated bd-animation-15 bd-no-margins" data-animation-name="bounceInLeft" data-animation-event="onload" data-animation-duration="1000ms" data-animation-delay="0ms" data-animation-infinited="false" href="<?php echo $logoLink; ?>">
<img class=" bd-imagestyles-144" <?php echo $logoSrc; ?> alt="<?php echo $sitename; ?>">
    ...
    <div class="bd-container-inner">
        ...
        <?php if ($facebook_off == 1) { ?><a target="_blank" class=" bd-socialicon-11 bd-socialicon" href="<?php echo $document->params->get('facebook'); ?>">
    <span class="bd-icon"></span><span></span>
</a><?php } ?>
    
        <?php if ($twitter_off == 1) { ?><a target="_blank" class=" bd-socialicon-12 bd-socialicon" href="<?php echo $document->params->get('twitter'); ?>">
    <span class="bd-icon"></span><span></span>
</a><?php } ?>
    
        <?php if ($google_off == 1) { ?><a target="_blank" class=" bd-socialicon-13 bd-socialicon" href="<?php echo $document->params->get('google'); ?>">
    <span class="bd-icon"></span><span></span>
</a><?php } ?>
    
        <?php if ($pinterest_off == 1) { ?><a target="_blank" class=" bd-socialicon-14 bd-socialicon" href="<?php echo $document->params->get('pinterest'); ?>">
    <span class="bd-icon"></span><span></span>
</a><?php } ?>
    
        <?php if ($linkedin_off == 1) { ?><a target="_blank" class=" bd-socialicon-15 bd-socialicon" href="<?php echo $document->params->get('linkedin'); ?>">
    <span class="bd-icon"></span><span></span>
</a><?php } ?>
		...
		<?php if ($search_off == 1) { ?><form id="search-4" role="form" class=" bd-search-4 bd-no-margins form-inline" name="search" <?php echo funcBuildRoute(JFactory::getDocument()->baseurl . '/index.php', 'action'); ?> method="post">
    <div class="bd-container-inner">
		...
		<?php if ($adress1_off == 1) { ?><div class=" bd-layoutbox-29 bd-no-margins clearfix">
    <div class="bd-container-inner">
...
<?php echo $document->params->get('bh1'); ?>&nbsp;&nbsp;<br><?php echo $document->params->get('bh2'); ?>
		...
		<?php if ($adress2_off == 1) { ?><div class=" bd-layoutbox-13 bd-no-margins clearfix">
    <div class="bd-container-inner">
